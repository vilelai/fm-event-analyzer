...
EVENT_CODES = {
    ...
    "423": {"nome": "DAMAGE - danificado na reimpressao (PRISM) [ERRO]", "desc": "Evento que NAO deveria ser feito. Pacote marcado como danificado na reimpressao de etiqueta no PRISM. Se ocorreu = erro. Bloqueia o fluxo completo -> pacote DEVE seguir processo de RTO (retorno).", "confirmed": True},
